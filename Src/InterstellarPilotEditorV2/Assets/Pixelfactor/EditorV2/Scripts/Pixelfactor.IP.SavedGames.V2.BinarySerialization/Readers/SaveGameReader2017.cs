...
{
    public class SaveGameReader2017 : ISaveGameReader
    {
        ...
        private void ReadUnitTractorerInfo(BinaryReader reader, SavedGame savedGame)
        {
            ...
            {
                var tractoringUnit = reader.ReadUnit(this.unitsById);
                var tractoredUnit = reader.ReadUnit(this.unitsById);

                if (tractoringUnit != null && tractoredUnit != null &&
                    tractoringUnit != tractoredUnit)
                {
                    savedGame.TractorerDataItems.Add(new ModelTractorerDataItem { TractoredUnit = tractoredUnit, TractoringUnit = tractoringUnit });
                }
            }
        }
        ...
        {
            var hasDefaultFleetSettings = reader.ReadBoolean();
        ...
        private void ReadPlayerUnitFleetSettings(BinaryReader reader, SavedGame savedGame)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                var modelPlayerUnitFleetSettings = new ModelPlayerUnitFleetSettings();
        ...
        {
            var homeBase = ReadSectorTarget(reader);
            var formationId = reader.ReadInt32();
            var fleetSettings = ReadFleetSettings(reader);
            var playerFleetSettings = ReadPlayerFleetSettingsItem(reader);

            var modelPlayerUnitFleetSettings = new ModelPlayerFleetSettingsCombined();
            modelPlayerUnitFleetSettings.FormationId = formationId;
            modelPlayerUnitFleetSettings.HomeBase = homeBase;
            modelPlayerUnitFleetSettings.FleetSettings = fleetSettings;
            modelPlayerUnitFleetSettings.FleetSettings.PlayerFleetSettings = playerFleetSettings;
            return modelPlayerUnitFleetSettings;
        }
        ...
        private ModelSectorTarget ReadSectorTarget(BinaryReader reader)
        {
            ...
            if (hasTarget)
            {
                return SectorTargetReader.Read(reader, this.sectorsById, this.unitsById, this.fleetsById);
            }
        ...
        private void ReadDitchedUnits(BinaryReader reader, SavedGame savedGame)
        {
            ...
            {
                var unit = reader.ReadUnit(this.unitsById);
                var expiryTime = reader.ReadInt32();
        ...
        {
            var modelEngineData = new ModelEngineData();
            modelEngineData.UnitIdCounter = reader.ReadInt32();
            modelEngineData.PlayerMessageIdCounter = reader.ReadInt32();
            modelEngineData.PersonIdCounter = reader.ReadInt32();
            modelEngineData.FactionIdCounter = reader.ReadInt32();
            modelEngineData.FleetOrderIdCounter = reader.ReadInt32();
            modelEngineData.PassengerGroupIdCounter = reader.ReadInt32();
            modelEngineData.JobIdCounter = reader.ReadInt32();
            modelEngineData.FleetIdCounter = reader.ReadInt32();
            modelEngineData.SectorIdCounter = reader.ReadInt32();
            modelEngineData.MissionIdCounter = reader.ReadInt32();
            modelEngineData.PatrolPathIdCounter = reader.ReadInt32();
            modelEngineData.MissionObjectiveIdCounter = reader.ReadInt32();
            return modelEngineData;
        }
        ...
        private void ReadTriggerGroups(BinaryReader reader, SavedGame savedGame)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                var triggerGroup = ReadTriggerGroup(reader);

                savedGame.TriggerGroups.Add(triggerGroup);
                this.triggerGroupsById.Add(triggerGroup.Id, triggerGroup);
            }

            // Read triggers/actions after groups due to link
            var groupTriggerCount = reader.ReadInt32();
            for (int t = 0; t < groupTriggerCount; t++)
            {
                var triggerGroup = reader.ReadTriggerGroup(triggerGroupsById);
                ...
                for (int i = 0; i < actionCount; i++)
                {
                    ...
                    triggerGroup.Actions.Add(action);
                }
            }
        }
        ...
        {
            var triggerGroup = new ModelTriggerGroup();
            triggerGroup.Id = reader.ReadInt32();
            triggerGroup.IsActive = reader.ReadBoolean();
            triggerGroup.FireAndDisable = reader.ReadBoolean();
            triggerGroup.EvaluateFrequency = reader.ReadSingle();

            triggerGroup.NextEvaluationTime = reader.ReadDouble();
            triggerGroup.FireCount = reader.ReadInt32();
            triggerGroup.MaxFireCount = reader.ReadInt32();
            triggerGroup.MaxFiredAction = (TriggerMaxFiredAction)reader.ReadByte();
        ...
        {
            var triggerType = (TriggerType)reader.ReadInt32();
            var modelTrigger = TriggerUtils.CreateModelTrigger(triggerType);
            ...
            switch (triggerType)
            {
                case TriggerType.Player_CurrentHudTarget:
                    {
                        var trigger = (ModelTrigger_Player_CurrentHudTarget)modelTrigger;
                        trigger.TargetUnit = reader.ReadUnit(this.unitsById);
                    }
                    break;
                case TriggerType.Player_IsPilotting:
                    {
                        var trigger = (ModelTrigger_Player_IsPilotting)modelTrigger;
                        trigger.WaitForHud = reader.ReadBoolean();
                    }
                    break;
                case TriggerType.Scenario_TimeElapsed:
                    {
                        var trigger = (ModelTrigger_Scenario_TimeElapsed)modelTrigger;
                        trigger.Time = reader.ReadSingle();
                    }
                    break;
            }
        ...
        {
            var actionType = (ActionType)reader.ReadInt32();
            var modelAction = ActionUtils.CreateModelAction(actionType);
                ...
                case ActionType.Player_NewMessageSimple:
                    {
                        ...
                        modelActionTyped.From = reader.ReadString();
                        modelActionTyped.To = reader.ReadString();
                        modelActionTyped.Subject = reader.ReadString();
                        modelActionTyped.Message = reader.ReadString();
                        modelActionTyped.Notifications = reader.ReadBoolean();
                    }
                    break;
                case ActionType.Mission_Activate:
                    {
                        var modelActionTyped = (ModelAction_Mission_Activate)modelAction;
                        modelActionTyped.Mission = reader.ReadMission(this.missionsById);
                    }
                    break;
                case ActionType.Mission_ChangeStage:
                    {
                        ...
                        var stageIndex = reader.ReadInt32();

                        var mission = missionsById.GetValueOrDefault(missionId);
                        if (mission != null && stageIndex < mission.Stages.Count)
                        {
                            modelActionTyped.Stage = mission.Stages[stageIndex];
                        }
                    }
                    break;
                case ActionType.Mission_ActivateObjective:
                    {
                        ...
                        {
                            var missionObjective = reader.ReadMissionObjective(this.missionObjectivesById);
                            if (missionObjective != null)
                            {
                                modelActionTyped.Objectives.Add(missionObjective);
                            }
                        }
                    }
                    break;
                case ActionType.Mission_CompleteObjective:
                    {
                        ...
                        modelActionTyped.MissionObjective = reader.ReadMissionObjective(missionObjectivesById);
                        modelActionTyped.Success = reader.ReadBoolean();
                    }
                    break;
                case ActionType.TriggerGroup_Activate:
                    {
                        var modelActionTyped = (ModelAction_TriggerGroup_Activate)modelAction;
                        modelActionTyped.TriggerGroup = reader.ReadTriggerGroup(this.triggerGroupsById);
                    }
                    break;
            }
        ...
        private void ReadFleetOrderAvailableCredits(BinaryReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                var orderIndex = reader.ReadInt32();
                var availableCredits = reader.ReadInt32();

                var fleet = this.fleetsById.GetValueOrDefault(fleetId);
                if (fleet != null && orderIndex >= 0 && orderIndex < fleet.OrdersCollection.Orders.Count)
                {
                    fleet.OrdersCollection.Orders[orderIndex].AvailableCredits = availableCredits;
                }
            }
        }
        ...
        private void ReadUnitScanRange(BinaryReader reader)
        {
            ...
            {
                var unit = reader.ReadUnit(this.unitsById);
                var scanRange = reader.ReadInt32();
                if (unit != null && unit.ComponentUnitData != null)
                {
                    unit.ComponentUnitData.ScanRange = scanRange;
                }
            }
        }
        ...
        private ModelPlayerFleetSettings ReadPlayerFleetSettingsItem(BinaryReader reader)
        {
            ...
            var playerFleetSettings = new ModelPlayerFleetSettings();
            playerFleetSettings.NotifyWhenOrderComplete = notifyOrderCompleted;
            playerFleetSettings.NotifyWhenScannedHostile = notifyWhenScannedHostile;
            playerFleetSettings.NotifyWhenAbandonedUnitFound = notifyWhenAbandonedUnit;
            playerFleetSettings.NotifyWhenAbandonedCargoFound = notifyWhenAbandonedCargoFound;
            return playerFleetSettings;
        }
        ...
        private ModelScenarioData ReadScenarioData(BinaryReader reader)
        {
            ...
            scenarioData.AllowTeleporting = reader.ReadBoolean();
        ...
        private ModelFactionTransaction ReadFactionTransaction(BinaryReader reader)
        {
            ...
            var relatedCount = reader.ReadInt32();
            transaction.RelatedCount = relatedCount > -1 ? relatedCount : null;
            return transaction;
        }
        ...
        private static ModelNpcPilotSettings ReadNpcPilotSettings(BinaryReader reader)
        {
            ...
            settings.AllowDitchShip = reader.ReadBoolean();
            return settings;
        }
        ...
        private ModelFactionCustomSettings ReadFactionCustomSettings(BinaryReader reader)
        {
            ...
            reader.ReadSingle(); // RepairMinHullDamage removed v2.0.58
            ...
            settings.CloakShipPreference = reader.ReadSingle();
        ...
        public ModelMission ReadMission(
            BinaryReader reader,
        ...
        {
            var missionTypeId = reader.ReadInt32();
            var missionType = (MissionType)missionTypeId;
            var modelMission = CreateMissionFromMissionType.Create(missionType);
            ...
            var stageCount = reader.ReadInt32();
            for (int i = 0; i < stageCount; i++)
            {
                var stage = ReadMissionStage(reader);
                modelMission.Stages.Add(stage);

                // Required for linking
                stage.Mission = modelMission;
            }

            var objectiveCount = reader.ReadInt32();
            for (var i = 0; i < objectiveCount; i++)
            {
                var objective = ReadMissionObjective(reader);
                modelMission.Objectives.Add(objective);
        ...
        private static ModelMissionObjective ReadMissionObjective(
            BinaryReader reader)
        {
            var objective = new ModelMissionObjective();
            objective.Id = reader.ReadInt32();
            objective.Title = reader.ReadString();
            objective.Description = reader.ReadString();
            objective.IsOptional = reader.ReadBoolean();
            objective.Order = reader.ReadInt32();
        ...
        {
            var missionStage = new ModelMissionStage();
            missionStage.CompletesMission = reader.ReadBoolean();
            missionStage.JournalEntry = reader.ReadString();
            missionStage.MissionSuccess = reader.ReadBoolean();
            return missionStage;
        }
            ...
            Dictionary<int, ModelSectorPatrolPath> patrolPaths)
        {
            ...
            order.Notifications = reader.ReadBoolean();
